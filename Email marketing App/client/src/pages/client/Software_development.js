...
class Software_development extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fullName: "",
  ...
  handleSubmit = e => {
    ...
    axios
      // .post(`${URI}/client/software-development`, client)
      .post("/client/software-development", client)
  ...
  render() {
    ...
    return (
      <div id="Client-page">
        <Nav />
        {/* Client page */}
        <h1 className="tracking-in-expand">Software development</h1>
